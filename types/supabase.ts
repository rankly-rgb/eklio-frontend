// ─────────────────────────────────────────────────────────────────────────────
// GENERATED FROM THE DATABASE, then the ADDENDUM below is re-applied by hand.
//
// ⚠ HOW THIS COPY WAS PRODUCED. The documented command is
//
//   supabase gen types typescript --db-url "$DB_URL" > types/supabase.ts
//
// against a clean replay of eklio-backend/supabase/migrations. That cannot run
// from this session's environment: no SUPABASE_ACCESS_TOKEN, Docker unusable so
// `--local` has no stack, and api.supabase.com refused by the network. This was
// generated by Supabase's OWN generator through the Supabase MCP server — the
// same endpoint the CLI's `--project-id` path calls — so these types are
// generated, not hand-written.
//
// THE DIFFERENCE THAT REMAINS: it reflects the LIVE project rather than a clean
// replay. Re-run the documented command when one is available and treat any
// diff as drift worth explaining.
//
// ⚠ THE ADDENDUM AT THE BOTTOM IS HAND-MAINTAINED and the generator cannot
  ...
  public: {
    Tables: {
      ...
      check_rewrite_usage: {
        ...
        Relationships: [
          {
            foreignKeyName: "check_rewrite_usage_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      content_checkins: {
        ...
        Relationships: [
          {
            foreignKeyName: "content_checkins_brand_kit_id_fkey"
            columns: ["brand_kit_id"]
            isOneToOne: false
            referencedRelation: "brand_kits"
            referencedColumns: ["id"]
      ...
      content_grounds: {
        ...
        Relationships: [
          {
            foreignKeyName: "content_grounds_month_id_fkey"
            columns: ["month_id"]
            isOneToOne: false
            referencedRelation: "content_months"
            referencedColumns: ["id"]
          },
        ]
      }
      content_image_allowance: {
        ...
        Relationships: [
          {
            foreignKeyName: "content_image_allowance_brand_kit_id_fkey"
            columns: ["brand_kit_id"]
            isOneToOne: false
            referencedRelation: "brand_kits"
            referencedColumns: ["id"]
      ...
      content_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "content_items_register_fkey"
            columns: ["register"]
            isOneToOne: false
            referencedRelation: "content_registers"
            referencedColumns: ["id"]
          },
        ]
      }
      content_months: {
        ...
        Relationships: [
          {
            foreignKeyName: "content_months_brand_kit_id_fkey"
            columns: ["brand_kit_id"]
            isOneToOne: false
            referencedRelation: "brand_kits"
            referencedColumns: ["id"]
      ...
      content_preferences: {
        ...
        Relationships: [
          {
            foreignKeyName: "content_preferences_brand_kit_id_fkey"
            columns: ["brand_kit_id"]
            isOneToOne: true
            referencedRelation: "brand_kits"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      mark_content_posted: {
        Args: { p_channel?: string; p_id: string; p_posted: boolean }
        Returns: Json
      }
      ...
      reserve_content_image: {
        Args: { p_brand_kit_id: string; p_cost_cents: number; p_month: string }
        Returns: Json
      }
      ...
      set_content_checkin: {
        Args: {
          ...
          p_happening?: string
          p_month: string
          p_sessions_theme?: string
          p_taking_clients?: string
        }
        Returns: Json
      }
      set_content_preferences: {
        Args: {
          p_accepted_registers: string[]
          p_brand_kit_id: string
      ...
      user_uploads_error: { Args: { p_code: string }; Returns: Json }
      user_uploads_quota_error: {
        Args: {
          p_brand_kit_id: string
          p_byte_size: number
          p_replacing?: string
...
/*
 * `MonthlyPresenceStatus` stood here. Its table was retired by the Content
 * chantier (backend 20260910082539) and nothing referenced the union but the
 * test that guarded it. `content_items` carries the live status vocabulary,
 * and it lives in lib/data/content.ts (`CONTENT_STATUSES`) rather than here.
 */
